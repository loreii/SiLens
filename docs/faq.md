...
We're exploring mask-programmable variants for future products that would allow different models per production batch.
...
Future generations will use more advanced nodes as open PDKs mature.
...
SiLens eliminates this entirely—weights are circuits, not data.
...
- Partnered with SkyWater on process optimization
...
|------------|----------|---------|-------|-------------|
| Gen 1 | 2028 | 130nm | SmolVLM-256M | This campaign |
...
<div class="feature-icon">🐛</div>
<h3>GitHub Issues</h3>
<p><a href="https://github.com/loreii/SiLens/issues">Report bugs & requests</a></p>
</div>
</div>
